...
TEST_CASE("cac_prover_logic<Field59Bit>_constructor") {
  ...
  a = allocate2D<Field59Bit>(n, m);
  t = allocate1D<Field59Bit>(n);
  secret = allocate1D<Field59Bit>(m);

  // Random matrix A
  for (auto nn = 0; nn < n; ++nn) {
    for (auto mm = 0; mm < m; ++mm) {
      a[nn][mm] = Field59Bit(prng.get<block>().halves[0]);
    }
  }

  // Random vector secret
  for (auto mm = 0; mm < m; ++mm) {
    secret[mm] = Field59Bit(prng.get<block>().bytes[0] % 2);
  }
  ...
  CacProverLogic<Field59Bit> p(param, a, t, secret);
...
TEST_CASE("cac_verifier_logic<Field59Bit>_constructor") {
  auto M = 50, tau = 13, N = 8, n = 4, m = 32;
  ...
  CacVerifierLogic<Field59Bit> v(param, a, t);
...
TEST_CASE("cac_prover_logic<Field59Bit>_r1") {
  auto M = 50, tau = 13, N = 8, n = 4, m = 32;
...
TEST_CASE("cac_verifier_logic<Field59Bit>_r2") {
  auto M = 50, tau = 13, N = 8, n = 4, m = 32;
...
TEST_CASE("cac_prover_logic<Field59Bit>_r3") {
  auto M = 50, tau = 13, N = 8, n = 4, m = 32;
...
TEST_CASE("cac_verifier_logic<Field59Bit>_r4") {
  auto M = 50, tau = 13, N = 8, n = 4, m = 32;
...
TEST_CASE("cac_prover_logic<Field59Bit>_r5") {
  auto M = 50, tau = 13, N = 8, n = 4, m = 32;
...
TEST_CASE("cac_verifier_logic<Field59Bit>_r6") {
  auto M = 50, tau = 13, N = 8, n = 4, m = 32;
...
TEST_CASE("cac_prover_logic<Field59Bit>_r7") {
  auto M = 50, tau = 13, N = 8, n = 4, m = 32;
  ...
  std::vector<std::vector<Field59Bit>> alpha_i_bar, b_square, s;
  std::vector<Field59Bit> o_i_bar;
...
TEST_CASE("cac_verifier_logic<Field59Bit>_r8") {
...
TEST_CASE("cac_verifier_logic<Field59Bit>_r8_reject") {
  auto M = 50, tau = 13, N = 4, n = 4, m = 32;
  ...
  secret[0] += Field59Bit(1); // Proof should be rejected now
...
TEST_CASE("cac_verifier_logic<Field59Bit>_protocol_big_numbers") {
...
TEST_CASE("cac_verifier_logic<Field59Bit>_protocol_big_numbers_reject") {
  auto M = 200, tau = 100, N = 16, n = 128, m = 1024;
...
TEST_CASE("sac_prover_logic<Field59Bit>_constructor") {
  ...
  SacProverLogic<Field59Bit> p(param, a, t, secret);
...
TEST_CASE("sac_verifier_logic<Field59Bit>_constructor") {
  auto M = 50, N = 8, n = 4, m = 32;
  ...
  SacVerifierLogic<Field59Bit> v(param, a, t);
...
TEST_CASE("sac_prover_logic<Field59Bit>_r1") {
  auto M = 50, N = 8, n = 4, m = 32;
...
TEST_CASE("sac_verifier_logic<Field59Bit>_r2") {
  auto M = 50, N = 8, n = 4, m = 32;
...
TEST_CASE("sac_prover_logic<Field59Bit>_r3") {
  auto M = 50, N = 8, n = 4, m = 32;
  ...
  for (auto e = 0; e < M; ++e) {
    ...
    Field59Bit o_sigma = Field59Bit(0);
    Field59Bit v_sigma = Field59Bit(0);
    for (auto i = 0; i < N; ++i) {
      o_sigma += p.provers_[e]->o_[i];
      v_sigma += p.provers_[e]->v_[i];
    }
    REQUIRE(o_sigma == Field59Bit(0));
    REQUIRE(v_sigma == Field59Bit(0));
  }
...
TEST_CASE("sac_verifier_logic<Field59Bit>_r4") {
  auto M = 50, N = 8, n = 4, m = 32;
...
TEST_CASE("sac_prover_logic<Field59Bit>_r5") {
  auto M = 50, N = 8, n = 4, m = 32;
  ...
  std::vector<std::vector<block>> seed_tree;
  std::vector<block> gamma_i_bar;
  std::vector<std::vector<Field59Bit>> alpha_i_bar, b_square, s, s_square;
  std::vector<Field59Bit> o_i_bar, v_i_bar;
...
TEST_CASE("sac_verifier_logic<Field59Bit>_r6") {
  auto M = 50, N = 8, n = 4, m = 32;
...
TEST_CASE("sac_verifier_logic<Field59Bit>_r6_reject") {
  auto M = 50, N = 8, n = 4, m = 32;
...
TEST_CASE("sac_verifier_logic<Field59Bit>_protocol_big_numbers") {
...
TEST_CASE("sac_verifier_logic<Field59Bit>_protocol_big_numbers_reject") {
  auto M = 200, N = 16, n = 128, m = 1024;
